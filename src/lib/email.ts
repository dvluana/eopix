          ...
          <tr>
            <td style="padding: 40px 20px;">
              <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="max-width: 480px; margin: 0 auto; background-color: #FFFFFF; border-radius: 8px; overflow: hidden; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.05);">
                ...
                <tr>
                  <td style="padding: 40px;">
                    <h2 style="margin: 0 0 16px 0; font-family: 'Zilla Slab', Georgia, serif; font-size: 24px; font-weight: 600; color: #1A1A1A;">
                      Relatório Pronto! 🎉
                    </h2>

                    <p style="margin: 0 0 24px 0; font-family: 'IBM Plex Mono', 'Courier New', monospace; font-size: 16px; line-height: 1.6; color: #1A1A1A;">
                      Seu relatório foi processado com sucesso e já está disponível para visualização.
                    </p>

                    <p style="margin: 0 0 24px 0; font-family: 'IBM Plex Mono', 'Courier New', monospace; font-size: 14px; line-height: 1.6; color: #666666;">
                      <strong style="color: #1A1A1A;">Código da compra:</strong> ${code}
                    </p>
                    ...
                    <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                      <tr>
                        <td style="text-align: center;">
                          <a href="${reportUrl}" style="display: inline-block; padding: 16px 32px; background-color: #FFD600; color: #1A1A1A; text-decoration: none; border-radius: 8px; font-family: 'IBM Plex Mono', 'Courier New', monospace; font-size: 16px; font-weight: 600;">
                    ...
                    <p style="margin: 24px 0 0 0; font-family: 'IBM Plex Mono', 'Courier New', monospace; font-size: 12px; line-height: 1.6; color: #666666; text-align: center;">
                      Este relatório ficará disponível por <strong style="color: #1A1A1A;">7 dias</strong>.
                    </p>
                  </td>
                </tr>
                ...
                <tr>
                  <td style="padding: 24px 40px 32px 40px;">
                    <p style="margin: 0 0 8px 0; font-family: 'IBM Plex Mono', 'Courier New', monospace; font-size: 12px; line-height: 1.5; color: #666666;">
                      ⚠️ Se o email não foi esperado, você pode ignorá-lo com segurança.
                    </p>
                    <p style="margin: 0; font-family: 'IBM Plex Mono', 'Courier New', monospace; font-size: 12px; line-height: 1.5; color: #666666;">
                      💡 Dica: Verifique sua pasta de spam se não encontrar este email.
                    </p>
                  </td>
                </tr>
